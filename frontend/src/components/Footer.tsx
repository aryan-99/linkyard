...
export function Footer() {
  return (
    <footer style={styles.footer}>
      <span style={styles.credit}>Built by Aryan Mittal</span>
      <a
        href="https://github.com/aryan-99/linkyard"
        target="_blank"
        rel="noopener noreferrer"
        style={styles.githubLink}
        aria-label="Linkyard on GitHub"
      >
        <GitHubIcon />
        <span style={styles.githubLabel}>GitHub</span>
      </a>
    </footer>
  );
}
